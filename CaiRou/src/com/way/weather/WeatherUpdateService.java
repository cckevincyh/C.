...
public class WeatherUpdateService extends Service {
	...
	private BroadcastReceiver mTimePickerBroadcast = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			if (intent.getAction().equals(
					WeatherActivity.UPDATE_WIDGET_WEATHER_ACTION)) {
				L.i("updateWeather.........");
				updateWeather();
			} else {
				updateTime();
	...
	public void onCreate() {
		...
		PendingIntent WeatherIconHotAreaPI = PendingIntent.getActivity(this, 0,
				new Intent(this, WeatherActivity.class), 0);
...
//				active, 0);
	...
	private void registerReceiver() {
		...
		updateIntent.addAction(WeatherActivity.UPDATE_WIDGET_WEATHER_ACTION);
